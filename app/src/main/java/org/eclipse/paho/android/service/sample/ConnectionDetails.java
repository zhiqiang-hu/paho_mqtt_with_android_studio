...
public class ConnectionDetails extends FragmentActivity implements
  ...
  /**
   * @see ActionBar.TabListener#onTabUnselected(ActionBar.Tab,
   *      FragmentTransaction)
   */
  @Override
  ...
  /**
   * @see ActionBar.TabListener#onTabSelected(ActionBar.Tab,
   *      FragmentTransaction)
   */
  @Override
  ...
  /**
   * @see ActionBar.TabListener#onTabReselected(ActionBar.Tab,
   *      FragmentTransaction)
   */
  @Override
